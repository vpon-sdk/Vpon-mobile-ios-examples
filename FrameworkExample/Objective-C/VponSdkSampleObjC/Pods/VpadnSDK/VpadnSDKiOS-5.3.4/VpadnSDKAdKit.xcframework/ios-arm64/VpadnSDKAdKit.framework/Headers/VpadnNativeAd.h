...
/// Deprecated registerViewForInteraction:withViewController:withClickableViews: method.
- (void)registerViewForInteraction:(UIView *)view withViewController:(UIViewController *)viewController withClickableViews:(NSArray *)clickableViews  DEPRECATED_MSG_ATTRIBUTE("Use registerViewForInteraction:withViewController: instead.");
