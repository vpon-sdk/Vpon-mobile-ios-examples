...
extern VpadnAdSize const VpadnAdSizeSmartBannerLandscape DEPRECATED_MSG_ATTRIBUTE("Use VpadnAdSizeFromCGSize instead.");
extern VpadnAdSize const VpadnAdSizeSmartBannerPortrait DEPRECATED_MSG_ATTRIBUTE("Use VpadnAdSizeFromCGSize instead.");
