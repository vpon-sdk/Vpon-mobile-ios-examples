 ...
 */
@interface OMIDVponAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDVponAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDVponAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDVponAdSessionContext *)context
