...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.data = [[NSDictionary alloc] initWithObjectsAndKeys: @"goVponSmaatoBannerViewController", @"SMAATO - Banner", @"goVponSmaatoInterstitialViewController", @"SMAATO - Interstitial", @"goVponSmaatoNativeViewController", @"SMAATO - Native",  nil];
    self.title = @"Menu";
}
