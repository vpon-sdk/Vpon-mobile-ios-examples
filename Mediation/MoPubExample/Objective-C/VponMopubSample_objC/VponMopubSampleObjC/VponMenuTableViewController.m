...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.data = [[NSDictionary alloc] initWithObjectsAndKeys: @"goVponMopubBannerViewController", @"MoPub - Banner", @"goVponMopubInterstitialViewController", @"MoPub - Interstitial", @"goVponMopubNativeViewController", @"MoPub - Native", nil];
    self.title = @"Menu";
}
