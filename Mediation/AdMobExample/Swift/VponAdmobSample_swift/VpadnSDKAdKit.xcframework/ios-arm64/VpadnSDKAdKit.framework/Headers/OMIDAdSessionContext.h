 ...
 */
@interface OMIDVponAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDVponPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDVponPartner *)partner
                               ...
                               resources:(NSArray<OMIDVponVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
